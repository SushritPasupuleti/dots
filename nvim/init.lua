...
require("lazy").setup({
    ...
    -- },
    {
        ...
        config = function()
            -- Don't auto-spawn; connect to an existing opencode instance running with --port
            ...
            -- Customize diffopt for opencode edit diffs (see :h 'diffopt')
            -- followwrap makes diff windows respect the wrap setting
            vim.opt.diffopt:append("followwrap")

            -- Wrap lines in diff views to avoid horizontal scroll
